...
function Navbar() {
  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300'>
      ...
      {/* social icons */}
      <div className='hidden lg:flex fixed flex-column top-[35%] left-0 font-bold'>
        <ul>
          <li
          ...
          >
            <a
              ...
              href='https://www.linkedin.com/in/razvan-calota-63492424a/'
            >
          ...
          >
            <a
              className='flex justify-between items-center w-full text-gray-300 '
              href='https://github.com/kforkenzor'
            >
